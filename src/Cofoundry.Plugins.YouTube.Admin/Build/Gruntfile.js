    ...
    grunt.initConfig({
        ...
        concat: {
            shared: {
                ...
                dest: '../Plugins/Admin/Modules/Shared/Content/js/youtube.js'
            },
            sharedHTML: {
                options: {
                ...
                dest: '../Plugins/Admin/Modules/Shared/Content/js/youtube_templates.js'
            },
        },
        ...
        uglify: {
            ...
            shared: {
                src: '../Plugins/Admin/Modules/Shared/Content/js/youtube.js',
                dest: '../Plugins/Admin/Modules/Shared/Content/js/youtube_min.js'
            },
        }
    });
